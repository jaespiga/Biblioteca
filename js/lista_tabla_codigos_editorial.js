$(document).ready(function(){     /* Ejecutar cuando la página esté cargada */
  var clave_tabla = document.getElementById('tabla_editorial').getAttribute('data-clave');
  ...
  .done(function(lista_select){
    $('#lista_edit').html(lista_select)         // Alta
    $('#lista_editE').html(lista_select)        // Edición
    $('#lista_editF').html(lista_select)        // Filtro
  })
  .fail(function(){
    Swal.fire({
      icon: 'error',
