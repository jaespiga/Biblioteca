$(document).ready(function(){     /* Ejecutar cuando la página esté cargada */
  var clave_tabla = document.getElementById('tabla_genlit').getAttribute('data-clave');
  ...
  .done(function(lista_select){
    $('#lista_genlit').html(lista_select)         // Alta
    $('#lista_genlitE').html(lista_select)        // Edición
    $('#lista_genlitF').html(lista_select)        // Filtro
  })
  .fail(function(){
    Swal.fire({
      icon: 'error',
