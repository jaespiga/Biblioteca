...
$(document).ready(function(){     /* Ejecutar cuando la página esté cargada */
    ...
    $("#lector").change(function(){  
        funcion_codigo = 1  // Leer descripción de la tabla de códigos
        tabla = "Lector";
        clave = document.getElementById('lector').value
        titulo = "Lector"
                                            ...
                                            $.ajax({
                                                ...
                                                .fail(function(){
                                                    Swal.fire({
                                                        icon: 'error',
                                                        title: 'Oops...',
                                                        text: 'Hubo un error al cargar los lectores',
                                                        footer: '<a href="">Revise  datos de entrada y base de datos/tabla: biblioteca.db / tgr00_codigos</a>'
                                                    })              
                                                })    
    ...
    // Edición    
    $("#lectorE").change(function(){  
        funcion_codigo = 1  // Leer descripción de la tabla de códigos
        tabla = "Lector";
        clave = document.getElementById('lectorE').value
        titulo = "Lector"
                                    ...
                                    .done(function(respuesta){  
                                        ...
                                        if (res[0] == 0) { // indicador de si el acceso a la base de datos ha sido correcto
                                            ...
                                            $.ajax({
                                                ...
                                                .done(function(lista_select){
                                                    $("#lista_lectoresE").empty();
                                                    $("#lista_lectoresE").html(lista_select); 
                                                })
                                                .fail(function(){
                                                    Swal.fire({
                                                        icon: 'error',
